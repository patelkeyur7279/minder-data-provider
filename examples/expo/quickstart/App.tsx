    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.buttonRow}>
          <Button title="Prev User" onPress={() => setUserId((id) => Math.max(1, id - 1))} />
          <Button title="Next User" onPress={() => setUserId((id) => Math.min(10, id + 1))} />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardText}>Document Dir: {FileSystem.documentDirectory}</Text>
          <Text style={styles.cardText}>Cache Dir: {FileSystem.cacheDirectory}</Text>
        </View>
      </View>
