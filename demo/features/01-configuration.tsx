...
import { MinderConfig, BaseModel } from "minder-data-provider";
  ...
  return (
    <div className='configuration-example'>
      ...
      <div className='config-section'>
        ...
        <ul>
          <li>
            <strong>enabled:</strong> Enable/disable CORS handling
          </li>
          <li>
            <strong>proxy:</strong> Next.js proxy route for CORS-free requests
          </li>
          <li>
            <strong>credentials:</strong> Include cookies and auth headers
          </li>
          <li>
            <strong>origin:</strong> Whitelist allowed domains
          </li>
        </ul>
      </div>
      ...
      <div className='config-section'>
        ...
        <ul>
          <li>
            <strong>environments:</strong> Override settings per environment
          </li>
          <li>
            <strong>autoDetectEnvironment:</strong> Auto-detect based on
            URL/NODE_ENV
          </li>
          <li>
            <strong>defaultEnvironment:</strong> Fallback environment
          </li>
        </ul>
      </div>
      ...
      <div className='config-section'>
        ...
        <ul>
          <li>
            <strong>model:</strong> Auto-transform API responses to model
            instances
          </li>
          <li>
            <strong>optimistic:</strong> Update UI immediately, rollback on
            error
          </li>
          <li>
            <strong>cache:</strong> Enable intelligent caching
          </li>
          <li>
            <strong>timeout:</strong> Per-route timeout settings
          </li>
        </ul>
      </div>
    </div>
