...
export function CrudOperationsExample() {
  ...
  const handleCreate = async () => {
    try {
      ...
      // Reset form
      setFormData({ name: '', price: 0, category: '', inStock: true, tags: '' });
    } catch (error) {
  ...
  return (
    <div className="crud-operations">
      ...
      <div className="status-panel">
        ...
        {errors.hasError && (
          <div className="error-panel">
            <h4>❌ Error Details</h4>
            <p><strong>Message:</strong> {errors.message}</p>
            <p><strong>Current Error:</strong> {errors.current?.message}</p>
          </div>
        )}
      </div>
            ...
            {products.map((product) => (
              <div key={product.id} className="product-card">
                ...
                <div className="product-details">
                  ...
                  <p><strong>Expensive:</strong> {product.isExpensive() ? '💰 Yes' : '💵 No'}</p>
                ...
                <div className="product-actions">
                  ...
                  <button 
                    onClick={() => handleDelete(product.id as string, product.name)}
      ...
      <div className="feature-explanation">
        ...
        <ul>
          <li><strong>🎣 useOneTouchCrud:</strong> Single hook provides all CRUD operations</li>
          <li><strong>⚡ Optimistic Updates:</strong> UI updates immediately, rolls back on error</li>
          <li><strong>🔄 Auto-Retry:</strong> Failed requests automatically retry with backoff</li>
          <li><strong>💾 Intelligent Caching:</strong> Reduces API calls, improves performance</li>
          <li><strong>🏢 Business Logic:</strong> Models encapsulate validation and methods</li>
          <li><strong>📊 Loading States:</strong> Granular loading states for each operation</li>
          <li><strong>🚨 Error Handling:</strong> Detailed error information with recovery</li>
          <li><strong>🔄 Cache Management:</strong> Manual refresh and cache clearing</li>
        </ul>
      </div>
    </div>
  );
