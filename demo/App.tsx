...
// import { AuthenticationExample } from './features/03-authentication.js'; // Commented out due to missing module
// import { FileUploadExample } from './features/05-file-upload.js'; // Commented out due to missing module
...
const featureTabs: FeatureTab[] = [
  {
    ...
    description:
      "Complete configuration options with CORS, auth, caching, and performance settings",
  },
  {
    id: "crud",
    ...
    description:
      "One-touch CRUD with optimistic updates, validation, and business logic",
  },
  // Removed tabs missing 'component' property
  {
    id: "websocket",
    title: "Real-Time",
    icon: "🔌",
    ...
    description:
      "WebSocket communication with chat, notifications, and presence system",
  },
];
      ...
      <header className='demo-header'>
        <div className='header-content'>
          <div className='header-left'>
            ...
            <h1 className='demo-title'>🚀 Minder Data Provider</h1>
            <span className='demo-subtitle'>Complete Demo & Documentation</span>
          </div>
            ...
            <div className='usage-examples'>
              ...
              <div className='examples-grid'>
                <div className='example-card'>
                  <h3>🚀 Basic Setup</h3>
                  <pre>
                    <code>{`import { MinderDataProvider } from 'minder-data-provider';
...
<MinderDataProvider config={config}>
  <App />
                ...
                <div className='example-card'>
                  ...
                  <pre>
                    <code>{`const { data, loading, operations } = useOneTouchCrud('users');
...
// Delete (optimistic)
await operations.delete(1);`}</code>
                  </pre>
                </div>
...
// Optimistic update
await cache.optimisticUpdate('users', updater);`}</code>
                  </pre>
                </div>
              </div>
            </div>
      ...
      <footer className='demo-footer'>
        <div className='footer-content'>
          <div className='footer-left'>
            <p>
              🚀 Minder Data Provider - Production-ready data management for
              Next.js
            </p>
          </div>
